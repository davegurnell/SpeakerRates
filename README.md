...
*"They're good speakers, Brent."*

A simple app for rating speakers after conference talks.
Shows three buttons:
...
- a volunteer at the conference holds the app up by the exit door;
- everyone votes by tapping a button as they leave the talk;
- a side menu on the right of the screen allows the volunteer
  to see the total scores and reset the app for the next talk.

Copyright 2017 Dave Gurnell. Licensed [Apache 2][license].
